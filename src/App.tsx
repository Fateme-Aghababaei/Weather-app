...
function App() {
  ...
  // Function to determine if it's day or night based on sunrise and sunset times
  ...
  return (
    <div className="relative bg-[url('/assets/Clouds.jpg')] bg-cover bg-center bg-no-repeat bg-fixed min-h-screen w-screen text-white">
      <div
